...
This small browser extension stops YouTube from forcing desktop mode on synced tabs by preventing the app=desktop query parameter.

It does this by redirecting from m.youtube.com to youtube.com directly bypassing app=desktop from being added.
